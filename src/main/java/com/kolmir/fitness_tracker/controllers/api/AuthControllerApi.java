...
public interface AuthControllerApi {
    ...
    ResponseEntity<?> signin(@Valid @RequestBody UserLoginRequest request);
    ...
    ResponseEntity<?> refreshToken(@RequestBody RefreshTokenRequest request) throws JwtNotValidException;
    ...
    ResponseEntity<?> signup(@Valid @RequestBody UserRegisterRequest request) throws UsernameAlreadyExistsException, EmailAlreadyInUseException;
}
