...
import com.kolmir.fitness_tracker.controllers.api.DayApi;
...
@RequestMapping("/days")
public class DayController implements DayApi {
    private final DayService dayService;

    @GetMapping
    public List<DayResponse> getAll(@RequestParam(required = false) String workoutName) {
        return dayService.getAllDays(workoutName != null ? Optional.of(workoutName) : Optional.empty());
    }
    ...
    @PostMapping
    public ResponseEntity<DayResponse> createDay(@RequestBody DayCreateRequest request) {
